...
class AuthorController extends Controller
{
     ...
     *
     * @Route("/", defaults={"page": 1}, name="author_index")
     * @Route("/page/{page}", requirements={"page": "[1-9]\d*"}, name="author_index_paginated")
     * @Method("GET")
     */
    public function indexAction($page)
    {
        ...
        $authors = $em->getRepository('AppBundle:Author')->getPaginated($page);
